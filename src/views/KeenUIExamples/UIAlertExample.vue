<template>
  <section class="page page--ui-alert">
    ...
    <p>
      UiAlert shows an inline alert message to the user. Supported types are
      <code>info</code>,
      <code>success</code>,
    ...
    <div class="page__examples">
      <ui-alert
        ...
        v-show="showAlert1"
      >Hi everybody! This is the default alert.</ui-alert>

      <ui-alert
        @dismiss="showAlert2 = false"
        type="success"
        v-show="showAlert2"
      >Okilly dokilly, your account was updated successfully.</ui-alert>

      <ui-alert @dismiss="showAlert3 = false" type="warning" v-show="showAlert3">
        Ay caramba! Alerts can also contain HTML.
        <a
          href="https://google.com"
          target="_blank"
          rel="noopener"
        >Click here</a> for Google.com.
      </ui-alert>

      <ui-alert
        @dismiss="showAlert4 = false"
        type="error"
        v-show="showAlert4"
      >D'oh! Something went wrong and we cannot process your request at this time. Try again later.</ui-alert>
      ...
      <ui-alert
        @dismiss="showAlert6 = false"
        v-show="showAlert6"
      >This is a multi-line alert. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolor suscipit facilis explicabo officiis consectetur, ipsam voluptate excepturi quas quae. Dolorem. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quis, autem.</ui-alert>

      <ui-alert
        @dismiss="showAlert7 = false"
        remove-icon
        v-show="showAlert7"
      >The icon for this alert has been removed.</ui-alert>

      <ui-alert
        @dismiss="showAlert8 = false"
        type="warning"
        disable-animation
        v-show="showAlert8"
      >Animations for this alert are disabled.</ui-alert>

      <ui-alert :dismissible="false">This alert is not dismissible.</ui-alert>

      <ui-alert :dismissible="false" remove-icon>This alert has no icon is not dismissible.</ui-alert>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <p>
                    Set to
                    <code>true</code> to remove the icon.
                  </p>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  ...
                  <p>
                    Set to
                    <code>true</code> to disable the animation.
                  </p>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  ...
                  <p>
                    ...
                    <code>dismiss</code> event and hide the alert.
                  </p>
                  <p>
                    Set to
                    <code>false</code> to remove the dismiss button.
                  </p>
                </td>
              </tr>
            </tbody>
